...
questions_path = "new_v2_OpenEnded_mscoco_test2015_questions.json"
...
for imageId in image_ids:
    ...
    i_new_path = new_images_path + "COCO_test2015_" + str(imageId).zfill(12) + ".jpg.npz"
